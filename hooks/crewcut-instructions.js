...
function getFallbackInstructions(mode) {
  return 'CREWCUT MODE ACTIVE — level: ' + mode + '\n\n' +
    ...
    '## Output\n\n' +
    'Code first (including its runnable check for non-trivial logic). Then a few short lines: what was skipped, what was assumed, the other reasonable reading of the request (or "none"), what the check asserts (or "none — trivial"), when to revisit. ' +
